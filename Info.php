...
<input  class="search" onclick="window.history.go(-1); return false;" style=" float:left;margin-left:15px;display: block;margin-top: 10px;" type="button" class="myButton" value="<- Retourner"/>
  <h2  style="text-align:center;margin-top: 40px;color: #4A4C49; ">Produit Info</h2>
<table width="100%">
...
<table>
  <tr align="center" valign="middle">
	<td class="extincteurtitle" style="text-align:left;padding:30px;">Info:</br><?php echo $row['Info']; ?></td>
  </tr>
</table>
</td>
<?php
